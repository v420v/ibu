...
gen:
	...
	movq (%rax), %rax
	push %rax
	leaq check_global_objects@GOTPCREL(%rip), %rax
	movq (%rax), %r10
	movq $0, %rax
	callq *%r10
	addq $16, %rsp
...
.text
	...
	movq (%rax), %rax
	push %rax
	leaq parse_function_params@GOTPCREL(%rip), %rax
	movq (%rax), %r10
	movq $0, %rax
	callq *%r10
	addq $32, %rsp
...
.L.end.115:
	...
	movq (%rax), %rax
	push %rax
	leaq add_function_object@GOTPCREL(%rip), %rax
	movq (%rax), %r10
	movq $0, %rax
	callq *%r10
	addq $16, %rsp
...
.text
	...
	movq (%rax), %rax
	push %rax
	leaq unkown_member_error@GOTPCREL(%rip), %rax
	movq (%rax), %r10
	movq $0, %rax
	callq *%r10
	addq $24, %rsp
...
.text
	...
	movq (%rax), %rax
	push %rax
	leaq unkown_type_error@GOTPCREL(%rip), %rax
	movq (%rax), %r10
	movq $0, %rax
	callq *%r10
	addq $24, %rsp
...
.L.end.288:
	...
	movq (%rax), %rax
	push %rax
	leaq cmp_type_vec@GOTPCREL(%rip), %rax
	movq (%rax), %r10
	movq $0, %rax
	callq *%r10
	addq $16, %rsp
...
.text
	...
	movq (%rax), %rax
	push %rax
	leaq unexpected_token_error@GOTPCREL(%rip), %rax
	movq (%rax), %r10
	movq $0, %rax
	callq *%r10
	addq $24, %rsp
...
unexpected_token_error:
	...
	movq (%rax), %rax
	push %rax
	leaq print_error_with_code@GOTPCREL(%rip), %rax
	movq (%rax), %r10
	movq $0, %rax
	callq *%r10
	addq $16, %rsp
...
.L.else.334:
	...
	movq (%rax), %rax
	push %rax
	leaq tokenizer_n_next@GOTPCREL(%rip), %rax
	movq (%rax), %r10
	movq $0, %rax
	callq *%r10
	addq $16, %rsp
...
eprintf:
	...
	movq $2, %rax
	push %rax
	leaq vfprintf@GOTPCREL(%rip), %rax
	movq (%rax), %r10
	movq $0, %rax
	callq *%r10
	addq $24, %rsp
