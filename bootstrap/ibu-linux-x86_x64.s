...
new_node_num:
	...
	leave
	ret
.global func_params_length_without_builtin
func_params_length_without_builtin:
	push %rbp
	movq %rsp, %rbp
	subq $0, %rsp
	leaq 16(%rbp), %rax
...
.text
	...
	movq (%rax), %rax
	push %rax
	leaq func_params_length_without_builtin(%rip), %rax
	movq %rax, %r10
	movq $0, %rax
	callq *%r10
	addq $8, %rsp
